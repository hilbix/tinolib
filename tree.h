 ...
 *
 * This is a gerneric data tree implementation in that the
 * representation is hidden from the caller.
 *
 * Currently there only is "ctree", which means, a character based
 * tree.  This is for storing unique strings (or data) associated with
